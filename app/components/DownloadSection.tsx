...
export default function DownloadSection() {
	return (
		<T id="components.downloadsection.0">
			<section
				id="download"
				className="py-24 relative overflow-hidden bg-[#060A13]"
			>
				{/* Background elements */}
					...
					<div className="flex flex-col lg:flex-row items-center justify-between lg:space-x-12">
						...
						>
							...
							<p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl">
								Start maximizing your credit card rewards with our intelligent
								AI-powered app. Available on iOS and Android.
							</p>

							<div className="flex flex-col sm:flex-row gap-4 mb-8">
								<a
									href="#"
									className="flex items-center justify-center bg-black hover:bg-[#333] border border-[#333] rounded-xl px-6 py-3 transition-colors"
								>
									<div className="mr-3">
										<svg
											viewBox="0 0 24 24"
