    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#090D15]/80 backdrop-blur-md border-b border-[#1E293B]">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-8">
              ...
              <li>
                <Link href="#how-it-works" className="text-foreground hover:text-accent transition-colors">
                  How it Works
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="#download" className="text-foreground hover:text-accent transition-colors">
                  Download
                </Link>
              </li>
            </ul>
      ...
      {mobileMenuOpen && (
        <motion.div 
          ...
          exit={{ opacity: 0, y: -20 }}
          className="md:hidden bg-[#0A0E17] border-b border-[#1E293B]"
        >
